...
public class ExpenseController {
    ...
    // NEW: Get monthly expenses summary with total
    ...
    // NEW: Get daily expenses summary with total
    ...
    // NEW: Get only monthly total (lightweight)
    ...
    // NEW: Get only daily total (lightweight)
